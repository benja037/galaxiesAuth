...
const AddSubjectScreen = ({ navigation, route }:SubjectProps) => {
    ...
    const post_subject = async () => {
        try {
            ...
            const response = await axios.post(`https://catolica-backend.vercel.app/apiv1/courses/${course_id}/subjectss/`, {course_id:course_id,subject_name:subject_name,
                headers: {
